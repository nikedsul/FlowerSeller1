...
/**
 * Enum FlowerNames contains names of flowers, the purchasing and retail prices of each type of flowers
...
public enum FlowerNames {
     ...
     */
    FlowerNames(double purchasingPrice, double extraCost, String flowerName) {
